...
#JAVANIB=/usr/lib/jvm/oracle-java8-jdk-amd64/bin/
#JAVANIB=/usr/lib/jvm/java-8-openjdk-amd64/bin/
...
javadoc::
	$(FIND) . -name "._*" -exec $(RM) {} \;
	$(MKDIR) javadoc
	$(JAVADOC) para para.calc para.graphic.shape para.graphic.target para.graphic.parser
